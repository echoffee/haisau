module.exports = {
    'Modify Project' : function (client) {
        client
            ...
            .assert.elementPresent("a[href*='modifyProject'][name*='DummyProjectName']")
            .click("a[href*='modifyProject'][name*='DummyProjectName']")
            .pause(1000)
            ...
            .assert.elementPresent("a[href*='modifyProject'][name*='DummyProjectNameEdited']") 
            .click("a[href*='modifyProject'][name*='DummyProjectNameEdited']")
            .pause(1000)
            .click("a")
            .pause(1000)
