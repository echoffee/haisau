...
| T2d | Design de la page de connexion | 2 | T0d, T1d | 0.5jh |
...
| T3d | Design de la page de déconnexion | 3 | T0d, T4d | 0.5jh |
...
| T4d | Design de la page présentant la liste des projets en cours | 4 | T0d, T2d | 0.5jh |
