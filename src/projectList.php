      ...
      <table style="width:100%">
        ...
        <?php
          ...
          foreach($conn->query($query) as $projet){
            ...
            echo "<tr><th><a href=''>".$projet['nom']."</a><a href='http://localhost:8080/modifyProject.php?id=".$projet['idProjet']."&name=".$projet['nom']."'><button type='button' id='edit-btn'>Edit</button></a><button type='button' id='delete-btn'>Delete</button></th><th>".$projet['currentSprint']['nom']."</th><th>".$projet['nbTachesDone']."/".$projet['nbTachesTotal']."</th><th>".$projet['currentSprint']['dateFin']."</th></tr>";
