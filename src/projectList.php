      ...
      <table style="width:100%">
        ...
        <?php
          ...
          foreach($conn->query($query) as $projet){
            ...
            echo "<tr><th><a href='userStoryList.php?id=". $projet['idProjet'] ."'>".$projet['nom']."</a><a href='modifyProject.php?id=".$projet['idProjet']."&name=".$projet['nom']."'><button type='button' id='edit-btn'>Edit</button></a><a href='deleteProject.php?id=".$projet['idProjet']."'><button type='button' id='delete-btn'>Delete</button></a></th><th>".$projet['currentSprint']['nom']."</th><th>".$projet['nbTachesDone']."/".$projet['nbTachesTotal']."</th><th>".$projet['currentSprint']['dateFin']."</th></tr>";
